...
function GameTest_Steam() {
    if [ "${USE_IPV6}" == 1 ]; then
        echo -n -e "\r Steam Currency:\t\t\t${Font_Red}Failed IPv6 Is Not Currently Supported${Font_Suffix}\n"
        return
    fi
    ...
    echo -n -e "\r Steam Currency:\t\t\t${Font_Green}Yes (Region: ${result})${Font_Suffix}\n"
}
...
function MediaUnlockTest_Tiktok_Region() {
    ...
    if [ -n "$SRegion" ]; then
        echo -n -e "\r Tiktok Region:\t\t\t\t${Font_Yellow}Yes (Region: ${SRegion})(IDC)${Font_Suffix}\n"
        return
    else
...
function RegionTest_iQYI() {
    ...
    echo -n -e "\r iQyi Oversea Region:\t\t\t${Font_Green}Yes (Region: ${region})${Font_Suffix}\n"
}
...
function RegionTest_YouTubeCDN() {
    ...
    if [ -z "$isIDC" ]; then
        ...
        echo -n -e "\r YouTube CDN:\t\t\t\t${Font_Yellow}Yes [${cdnISP}] in [${location}]${Font_Suffix}\n"
        return
    fi
    if [ -n "$isIDC" ]; then
        echo -n -e "\r YouTube CDN:\t\t\t\t${Font_Green}Yes (Region: ${location})${Font_Suffix}\n"
        return
    fi
...
function MediaUnlockTest_ESPNPlus() {
    ...
    if [ -z "$refreshToken" ]; then
        echo -n -e "\r ESPN+:\t\t\t\t${Font_Red}Failed (Error: PAGE ERROR)${Font_Suffix}\n"
        return
    fi
...
function RegionTest_oneTrust() {
    ...
    echo -n -e "\r OneTrust Region:\t\t\t${Font_Green}Yes (Region: ${region})[${stateName}]${Font_Suffix}\n"
}
...
function RegionTest_Bing() {
    ...
    echo -n -e "\r Bing Region:\t\t\t\t${Font_Green}Yes (Region: ${region})${Font_Suffix}\n"
}
